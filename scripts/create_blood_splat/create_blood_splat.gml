/// @description create_blood_splat(x, y, hitscan_emitter, is_knife, depth)
/// @param x
/// @param  y
/// @param  hitscan_emitter
/// @param  is_knife
/// @param  depth
function create_blood_splat(argument0, argument1, argument2, argument3, argument4) {
