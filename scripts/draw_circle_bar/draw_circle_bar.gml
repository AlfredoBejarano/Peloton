/// @description draw_circle_bar(x,y,radius,maxsegments,segments,startangle,totalangle,direction,colour)
/// @param x
/// @param y
/// @param radius
/// @param maxsegments
...
/// @param direction
/// @param colour
function draw_circle_bar(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7, argument8) {
