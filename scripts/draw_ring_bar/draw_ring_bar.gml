/// @description draw_ring_bar(x,y,radius,thickness,maxsegments,segments,startangle,totalangle,direction,colour)
/// @param x
/// @param y
/// @param radius
/// @param thickness
...
/// @param direction
/// @param colour
function draw_ring_bar(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7, argument8, argument9) {
