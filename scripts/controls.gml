...
if(control) {    
    ...
    // Player movement
    movement(is_aiming, keyboard_check(up), keyboard_check(down), keyboard_check(left), keyboard_check(right));
    ...
    if(keyboard_check_pressed(weaponnext) && current_weapon < ds_list_size(weapons_inventory)-1 && is_reloading == 0 && is_shooting == 0 && is_aiming == 0 && weapon != obj_wep00) { 
        ...
        weapon = ds_list_find_value(weapons_inventory, current_weapon);
