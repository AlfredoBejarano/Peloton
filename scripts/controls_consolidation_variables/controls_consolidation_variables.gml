/// @description  controls_consolidation_variables(Reload key (pressed), Aim key (check), Shoot key (pressed))
/// @param Reload key (pressed
function controls_consolidation_variables() {
