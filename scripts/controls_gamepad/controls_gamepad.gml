/// @description  controls_gamepad()
function controls_gamepad() {
	...
	/* RELOAD BEGINS */
	perform_reload(gamepad_button_check_pressed(device, reload), gamepad_button_check_pressed(device, shoot));
	/* RELOAD ENDS */
