/// @description create_hitscan(x, y, distance, hitscan y, emitter object, y delta)
/// @param x
/// @param  y
/// @param  distance
/// @param  hitscan y
...
/// @param  y delta
function create_hitscan(argument0, argument1, argument2, argument3, argument4, argument5) {
	/*
