/// @description  perform_touch_aim(Aim key (check), Aim key (pressed), Shoot key (check), Shoot key (pressed), Aim key (released), Reload key (pressed), Player object)
/// @param Aim key (check
function perform_touch_aim(argument0, argument1, argument2, argument3, argument4, argument5, argument6) {
